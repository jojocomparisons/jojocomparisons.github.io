...
{% img center /images/PB01/01header.jpg %}
<!-- more -->
...
- ...And the second kanji in 製作 ("Production") has instead been slightly moved to the left (look, I know nobody cares about these things, but I've gotta include everything for completeness' sake!):
